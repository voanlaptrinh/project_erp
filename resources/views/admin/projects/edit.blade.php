            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.projects.update', $project->alias) }}" method="POST" class="row g-3">
                            @csrf
                            @method('PUT') <!-- Đặt phương thức PUT để cập nhật dữ liệu -->
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="ten_du_an" id="ten_du_an" class="form-control"
                                        value="{{ old('ten_du_an', $project->ten_du_an) }}" required>
                                    ...
                                    <div>
                                        ...
                                        <select name="trang_thai" id="trang_thai" class="form-select">
                                            <option value="Chưa bắt đầu"
                                                {{ old('trang_thai', $project->trang_thai) == 'Chưa bắt đầu' ? 'selected' : '' }}>
                                                Chưa bắt đầu
                                            </option>
                                            <option value="Đang thực hiện"
                                                {{ old('trang_thai', $project->trang_thai) == 'Đang thực hiện' ? 'selected' : '' }}>
                                                Đang thực hiện
                                            </option>
                                            <option value="Tạm dừng"
                                                {{ old('trang_thai', $project->trang_thai) == 'Tạm dừng' ? 'selected' : '' }}>
                                                Tạm dừng</option>
                                            <option value="Hoàn thành"
                                                {{ old('trang_thai', $project->trang_thai) == 'Hoàn thành' ? 'selected' : '' }}>
                                                Hoàn thành</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="ngay_bat_dau" id="ngay_bat_dau" class="form-control"
                                            value="{{ old('ngay_bat_dau', $project->ngay_bat_dau) }}">
                                    </div>
                                    @error('ngay_bat_dau')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="ngay_ket_thuc" id="ngay_ket_thuc" class="form-control"
                                            value="{{ old('ngay_ket_thuc', $project->ngay_ket_thuc) }}">
                                    </div>
                                    @error('ngay_ket_thuc')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                                ...
                                                <div>
                                                    <div class="checkbox-wrapper-31">
                                                        <input type="checkbox" name="user_ids[]"
                                                            value="{{ $user->id }}"
                                                            {{ isset($assignedUsers) && in_array($user->id, $assignedUsers) ? 'checked' : '' }} />
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="mo_ta" id="tyni" class="form-control" rows="4">{{ old('mo_ta', $project->mo_ta) }}</textarea>
                                </div>
                                @error('mo_ta')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
